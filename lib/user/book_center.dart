...
class BookCenter extends StatefulWidget {
  String centerName;
  static const routeName = '/bookCenter';
  BookCenter({required this.centerName});

  @override
  State<BookCenter> createState() => _BookCenterState();
}

class _BookCenterState extends State<BookCenter> {
                      ...
                      onPressed: () async {
                        ...
                        if (user != null) {
                          ...
                          DatabaseReference companyRef = FirebaseDatabase
                              .instance
                              .reference()
                              .child('centersBookings').child(widget.centerName);
