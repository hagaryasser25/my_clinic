...
class _CenterListState extends State<CenterList> {
  ...
  void fetchBookings() async {
    ...
    base = database.reference().child("centersBookings").child(widget.name);
    base.onChildAdded.listen((event) {
      print(event.snapshot.value);
      CBooking p = CBooking.fromJson(event.snapshot.value);
      bookingList.add(p);
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Align(
                                        alignment: Alignment.topRight,
                                        child: Text(
                                          'نوع التحليل : ${bookingList[index].type.toString()}',
                                          style: TextStyle(
                                              fontSize: 17,
                                              fontWeight: FontWeight.w600,
                                              fontFamily: 'Cairo'),
